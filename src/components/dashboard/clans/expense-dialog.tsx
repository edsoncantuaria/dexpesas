...
export function ExpenseDialog({ isOpen, onClose, clanId, clanBalance, onSuccess }: ExpenseDialogProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Registrar Despesa da Família</DialogTitle>
          <DialogDescription>
            Use o dinheiro do caixa comum para pagar uma despesa coletiva. Saldo disponível: {clanBalance.toLocaleString('pt-BR', {style: 'currency', currency: 'BRL'})}
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
