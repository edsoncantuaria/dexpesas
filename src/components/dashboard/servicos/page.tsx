...
const serviceItems: ServiceItem[] = [
    ...
    },
    {
    ...
    },
     {
        ...
        title: 'Orçamentos',
        description: 'Defina limites de gastos mensais',
        Icon: Target,
    ...
    },
    {
     ...
     {
        href: '/dashboard/guildas',
        title: 'Clãs',
        description: 'Junte-se a outros aventureiros',
        Icon: Swords,
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {serviceItems.map((item) => (
                    <Link href={item.href} key={item.href} className="group">
                        <div className="bg-card p-4 rounded-lg border flex items-center gap-4 transition-all group-hover:border-primary group-hover:bg-primary/5">
