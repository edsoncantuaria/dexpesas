...
export function FinalizeGoalDialog({ isOpen, isSaving, goal, accounts, categories, onClose, onSave }: FinalizeGoalDialogProps) {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>Parabéns por alcançar seu objetivo!</DialogTitle>
                    <DialogDescription>
                        Você acumulou {Number(goal.currentAmount).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })} para "{goal.name}". O que você quer fazer com o dinheiro?
                    </DialogDescription>
                </DialogHeader>
                <Form {...form}>
