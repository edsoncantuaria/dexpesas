...
import { ClanBankCard } from '@/components/dashboard/clans/clan-bank-card';
import { ClanGoalsCard } from '@/components/dashboard/clans/clan-goals-card';
import { ClanActivityFeed } from '@/components/dashboard/clans/clan-activity-feed';
import { ClanHeader } from '@/components/dashboard/clans/clan-header';
import { useRouter } from 'next/navigation';
import { ClanSharedExpenses } from '@/components/dashboard/clans/clan-shared-expenses';
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/components/ui/tabs';
import { Home, List, Users } from 'lucide-react';
import { FamilyMembersTab } from '@/components/dashboard/clans/family-members-tab';
