...
export function ReconcileView({ reconciliation, manualTransactions, onMatch, onDiscard, onTransactionCreated, onFinalize, onCancel }: ReconcileViewProps) {
    ...
    const handleCreateAll = async () => {
        ...
        try {
            ...
            toast({ title: 'Importação em Lote Concluída', description: response.data.message });
            onTransactionCreated();
        } catch (error: any) {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr] items-start gap-4">
                        ...
                        <ScrollArea className="h-[60vh]">
                            <Table>
                                <TableHeader className="sticky top-0 bg-muted z-10">
                                    <TableRow>
                                        <TableHead colSpan={2} className="p-2">
                ...
                <div className="flex flex-col items-center justify-start gap-2 pt-4">
                    ...
                    {pendingImportedCount > 0 && (
                        ...
                        Importar Todas ({pendingImportedCount})
                        </Button>
                    )}
                </div>
